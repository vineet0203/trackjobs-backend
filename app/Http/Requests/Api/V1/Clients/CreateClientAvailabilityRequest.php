...
class CreateClientAvailabilityRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'availabilty_notes' => ['nullable', 'string', 'max:1000'],
    ...
    public function messages(): array
    {
        return [
            ...
            'preferred_start_time.required' => 'Start time is required.',
            'preferred_start_time.date_format' => 'Start time must be in HH:mm format.',
            'preferred_end_time.required' => 'End time is required.',
            ...
            'schedule_start_date.required' => 'Schedule start date is required.',
            'schedule_start_date.date' => 'Schedule start date must be a valid date.',
            'schedule_start_date.after_or_equal' => 'Schedule start date cannot be in the past.',
            ...
            'availabilty_notes.max' => 'Availabilty Notes cannot exceed 1000 characters.',
    ...
    {
        $this->merge([
            'has_lunch_break' => filter_var($this->has_lunch_break ?? false, FILTER_VALIDATE_BOOLEAN),
